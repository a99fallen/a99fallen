...
public class BoardBuilder {
    ...
    public BoardBuilder submarine(char row, int col, boolean horizontal) {
        placeShip(ShipsFactory.submarine(), row, col, horizontal);
        return this;
    }

    public BoardBuilder destroyer(char row, int col, boolean horizontal) {
        placeShip(ShipsFactory.destroyer(), row, col, horizontal);
        return this;
    }

    public BoardBuilder cruiser(char row, int col, boolean horizontal) {
        placeShip(ShipsFactory.cruiser(), row, col, horizontal);
        return this;
    }

    public BoardBuilder warship(char row, int col, boolean horizontal) {
        placeShip(ShipsFactory.warship(), row, col, horizontal);
        return this;
    }

    public BoardBuilder carrier(char row, int col, boolean horizontal)
    {
        placeShip(ShipsFactory.carrier(), row, col, horizontal);
        return this;
    }

    public BoardBuilder missedShoot(char row, int col, boolean horizontal) {
        placeShip(ShipsFactory.missedShoot(), row, col, horizontal);
        return this;
    }

    private void placeShip(Ship ship, char row, int col, boolean horizontal) {
        requireShipIsAvailable(ship);
        Set<Field> fieldsToUse = computeFields(ship, row, col, horizontal);
    ...
    private Set<Field> computeFields(Ship ship, char row, int col, boolean horizontal) {
